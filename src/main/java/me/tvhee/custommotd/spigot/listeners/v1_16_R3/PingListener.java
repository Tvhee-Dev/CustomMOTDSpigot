package me.tvhee.custommotd.spigot.listeners.v1_16_R3;
...
import net.minecraft.server.v1_16_R3.ChatTypeAdapterFactory;
...
public class PingListener implements Listener
{
    ...
    public static class ServerPingEvent extends ServerPing.Serializer
    {
        ...
        public JsonElement serialize(ServerPing serverPing, Type type, JsonSerializationContext jsonSerializationContext)
        {
            ...
            {
                serverData.setField("b", 1);
                serverData.setField("a", ChatUtils.format(CustomMOTDPlugin.getInstance().getConfig().getString("plugin.player-format.text").replaceAll("%online-players%", String.valueOf(Bukkit.getServer().getOnlinePlayers().size())).replaceAll("%max-players%", String.valueOf(Bukkit.getServer().getMaxPlayers()))));
            }
