package me.tvhee.custommotd.spigot.listeners.v1_13_R2;
...
public class PingListener implements Listener
{
    ...
    {
        @Override
        public JsonElement a(ServerPing.ServerData serverData, Type type, JsonSerializationContext jsonSerializationContext)
        {
    ...
    {
        @Override
        public JsonElement a(ServerPing.ServerPingPlayerSample serverPingPlayerSample, Type type, JsonSerializationContext jsonSerializationContext)
        {
